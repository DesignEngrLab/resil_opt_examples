...
class Tank(Model):
    def __init__(self, params={'capacity':20,'turnup':1.0, 'faultpolicy':{(a-1,b-1,c-1):(0,0) for a,b,c in np.ndindex((3,3,3))}},\
                 modelparams = {'phases':{'na':[0,1],'operation':[1,20]}, 'times':[0,5,10,15,20], 'tstep':1, 'units':'min'}, valparams={}):
